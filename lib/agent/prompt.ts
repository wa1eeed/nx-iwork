  ...
  if ((ctx.audience ?? 'customer') === 'internal') {
    ...
    sections.push(
      [
        ...
        '  5) بعد اختيار العميل، ثبّت الحجز فعلياً باستدعاء أداة create_booking ممرّراً serviceId والوقت المختار (ISO) واسم العميل ورقم جواله (customerName + customerPhone) أو customerId — استدعِ الأداة فعلاً وانتظر نتيجتها، ولا تفترض النجاح ولا تتخطَّ هذه الخطوة مهما بدا الحوار مكتملاً.',
