  ...
  if ((ctx.audience ?? 'customer') === 'internal') {
    ...
    sections.push(
      [
        ...
        '  • سؤال/استعلام (كم موعد اليوم؟ من هم عملاء الغد؟ ما طابور فلان؟ ما مواعيد العميل س؟ ما مبيعات اليوم؟): استدعِ الأداة القارئة المناسبة **فوراً** وأجب بالأرقام الفعلية. **لا تُنشئ مهمة (create_task) للإجابة عن سؤال أبداً.**',
