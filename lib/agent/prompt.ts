  ...
  if ((ctx.audience ?? 'customer') === 'internal') {
    ...
    sections.push(
      [
        ...
        '  5) بعد أن يختار العميل وقتاً، ثبّت الحجز باستدعاء create_booking ممرّراً: serviceName (كما في الكتالوج، دائماً)، و**قيمة startAt الحرفية المطابقة للوقت الذي اختاره** من نتيجة list_open_slots — انسخها كما هي حرفاً بحرف ولا تُعِد بناء الوقت من نصّ العرض بنفسك أبداً (هذا يسبب انزياح الساعة)، واسم العميل ورقم جواله (customerName + customerPhone) أو customerId. استدعِ الأداة فعلاً وانتظر نتيجتها، ولا تفترض النجاح.',
