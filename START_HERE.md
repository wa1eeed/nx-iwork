...
> ▶️ **استئناف العمل؟ ابدأ من `docs/CONTINUE_HERE.md`** — فيه آخر حالة للمشروع وما
> تبقّى وكيفية الإكمال من حيث توقّفنا.
>
> ✅ **تحديث (2026-06-20):** النواة الأساسية **مبنية ومنشورة** على [bznss.one](https://bznss.one/)،
> بالإضافة إلى: أكواد مرجعية لكل سجل، إعادة تصميم إنجليزية-أولاً (شريط جانبي، تسجيل/أونبوردنغ،
> إعدادات، CRM)، و**نظام الموارد البشرية ودورة حياة الوكلاء** (٩ قوالب، فحص تعارض، تهيئة معرفية،
> هيكل تنظيمي، `/api/hr/deploy`)، تصعيد الشكاوى لتيليجرام، سقف توكنز لكل وكيل، و RLS.
> **المتبقّي:** ترجمة المكوّنات العميقة (i18n)، وتفعيل RLS بالكامل عبر `withTenant`.
> راجع `docs/CONTINUE_HERE.md` و`CHANGELOG.md` و`docs/TODO.md`.
